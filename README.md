...
<h3>MongoDb | Mongoose | SQL | PostgreSql | Sequelize | Node.js | Express | JavaScript | React | Redux | Docker | Microservicios | Maquinas Virtuales(Google Cloud) | Scrum | Git | .</h3>
...
[FoodAppRepo](https://github.com/San896/WheatherApp)
  <h3> SPA, a App of Wheather, you can search cities and take a look of the info of their wheather</h3>
...
- ⚡Star Wars API 
[ApiStarWarsRepo](https://github.com/San896/Microservices) --
  <h3> API, you can get data of characters, films and planets </h3>
    <img src="./img/capturamicroservicesworking.png" alt="failed banner img" width="350" height="300">
